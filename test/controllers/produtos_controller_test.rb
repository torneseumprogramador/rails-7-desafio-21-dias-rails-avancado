...
class ProdutosControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create produto" do
    assert_difference("Produto.count") do
      post produtos_url, params: { produto: { descricao: @produto.descricao, nome: @produto.nome, quantidade_estoque: @produto.quantidade_estoque, valor: @produto.valor } }
    end
  ...
  test "should update produto" do
    patch produto_url(@produto), params: { produto: { descricao: @produto.descricao, nome: @produto.nome, quantidade_estoque: @produto.quantidade_estoque, valor: @produto.valor } }
